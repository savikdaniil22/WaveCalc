    ...
    <main className="min-h-screen bg-slate-950 text-slate-100">
      <div className="mx-auto grid w-full max-w-7xl gap-4 p-4 md:grid-cols-12 md:p-6">
        <header className="rounded-xl border border-slate-800 bg-slate-900/80 p-6 md:col-span-12">
          ...
          Система предназначена для оценки качества радиолинии и анализа устойчивости канала связи на основе расчета потерь сигнала, 
          уровня принимаемой мощности и запаса по замиранию.
          </p>
        </header>
